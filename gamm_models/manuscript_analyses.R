...
birth_demo <-  birth_data %>% select(PMA_scan, child_sex,GAWEEKS, child_birthweight, ADI, income_needs_demo_b, demo_edu_b,insurance_status_birth,HEI_birth, disadv_prenatal)
